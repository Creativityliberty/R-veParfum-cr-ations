...
export default function DeliveryPage({
  ...
  const steps = [
    ...
    },
    {
      ...
      desc: "Chaque cire végétale bio est coulée individuellement à la main dans notre atelier de Normandie (deux semaines en moyenne).",
    },
    {
      num: "04",
  ...
  const seasonalMonths = [
    ...
    },
    {
      ...
      desc: "Durant les fortes chaleurs estivales, nous encourageons chaleureusement le retrait gratuit directement en Normandie afin de préserver l'intégrité de la cire de soja.",
      active: false,
  ...
  const faqs = [
    ...
    {
      q: "Où se situe l'atelier pour le retrait gratuit en Normandie ?",
      a: "Notre atelier de création se situe en Seine-Maritime (76) en Normandie, à Saint-Ouen-le-Mauger et Saint-Pierre-Bénouville. Les coordonnées GPS exactes ou notre adresse vous seront amicalement indiquées par WhatsApp une fois vos produits assemblés.",
    },
    {
      ...
      <div className="space-y-20 pt-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch bg-brand-depth/25 p-6 md:p-8 rounded-3xl border border-brand-pink/10 relative overflow-hidden">
          <div className="space-y-4">
            ...
            <p className="text-xs text-brand-text-muted leading-relaxed font-light">
              Pour récupérer vos colis, nous vous proposons la livraison sécurisée via Mondial Relay (en point relais ou Lockers) ou le retrait gratuit en main propre à notre atelier de Normandie. 
            </p>
          ...
          <div className="relative p-6 bg-brand-bg rounded-2xl border border-brand-pink/5 flex flex-col justify-center items-center text-center space-y-4 shadow-inner min-h-[200px] overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col items-center">
              <div className="flex justify-center mb-3 bg-white px-4 py-2 rounded-xl shadow-md border border-zinc-100">
                <img 
                  src="https://www.mondialrelay.fr/media/126147/mondial-relay-by-inpostsvglogo.png" 
